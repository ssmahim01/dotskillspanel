  ...
  return {
    ...
    updateClient: useMutation({
      mutationFn: ({
        ...
        id: string;
        payload: Parameters<typeof clientApi.updateClient>[1];
    ...
    permanentlyDeleteClient: useMutation({
      mutationFn: clientApi.permanentlyDeleteClient,
      onSuccess: invalidate,
    }),
    ...
    updateStatus: useMutation({
      mutationFn: ({
        ...
        id: string;
        payload: Parameters<typeof clientApi.updateStatus>[1];
    ...
    assignManager: useMutation({
      mutationFn: ({
        ...
        id: string;
        payload: Parameters<typeof clientApi.assignManager>[1];
    ...
    addNote: useMutation({
      mutationFn: ({
        ...
        id: string;
        payload: Parameters<typeof clientApi.addNote>[1];
    ...
    addDocument: useMutation({
      mutationFn: ({
        ...
        id: string;
        payload: Parameters<typeof clientApi.addDocument>[1];
